---
{"dg-publish":true,"permalink":"/docs/tsql/storage/temp-db/","tags":["tsql","sql-server","tempdb","performance"]}
---
...
See [[docs/tsql/storage/Transaction Logs\|Transaction Logs & Massive Deletes]] for strategies when large deletes cause tempdb and log growth.
