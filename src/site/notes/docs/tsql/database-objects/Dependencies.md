---
{"dg-publish":true,"permalink":"/docs/tsql/database-objects/dependencies/","tags":["tsql","sql-server","dependencies","objects"]}
---
...
> [!Warning] 
> `sp_depends` has limitations — it may miss dependencies created via dynamic SQL or cross-database references. Use the DMVs below for a more complete picture.
