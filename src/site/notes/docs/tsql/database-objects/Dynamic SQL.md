---
{"dg-publish":true,"permalink":"/docs/tsql/database-objects/dynamic-sql/","tags":["tsql","sql-server","dynamic-sql","sp-executesql"]}
---
...
> [!Warning] 
> Dynamic SQL increases complexity, bypasses compile-time validation, and can introduce SQL injection risks if not handled carefully. Always prefer `sp_executesql` with parameters over string concatenation.
