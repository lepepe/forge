---
{"dg-publish":true,"permalink":"/docs/csharp/strings-and-arrays/string-manipulation-methods/","tags":["csharp","methods","string-manipulation","substring","strings"]}
---
...
- [[docs/csharp/strings-and-arrays/String Split and Join\|String Split and Join]]
- [[docs/csharp/strings-and-arrays/String Formatting\|String Formatting]]
- [[docs/csharp/control-flow/For Loop\|For Loop]]
- [[docs/csharp/control-flow/While and Do-While Loops\|While and Do-While Loops]]
