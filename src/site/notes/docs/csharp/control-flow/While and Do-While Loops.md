---
{"dg-publish":true,"permalink":"/docs/csharp/control-flow/while-and-do-while-loops/","tags":["csharp","loops","while-loop","do-while","break","continue"]}
---
...
- [[docs/csharp/fundamentals/Boolean Expressions\|Boolean Expressions]]
- [[docs/csharp/fundamentals/Code Blocks and Variable Scope\|Code Blocks and Variable Scope]]
- [[docs/csharp/control-flow/Switch Statement\|Switch Statement]]
