...
- In ASP.NET Core apps, prefer registering a service as `AddSingleton<T>` in the DI container instead of hand-rolling this pattern -- see [[docs/csharp/oop/Interfaces, Constructors, and Dependency Injection\|Service Lifetimes]]
